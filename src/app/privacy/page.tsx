...
const Privacy = () => {
  const md = `
This privacy policy (“Policy”) describes how B2 Network. (“we”, “our”, or “us”) collects, uses, shares, and stores personal information of users of its B2 Network Wallet Proxy Chrome Extention,  (the “Proxy”). This Policy applies to the Sites, applications, products and services (collectively, “Services”) on or in which it is posted, linked, or referenced. 
...
B2 Network Wallet Proxy Chrome Extention does not collect any user data. The data required or generated during interaction between users and B2 Network Wallet Proxy Chrome Extention are stored locally on the user's device.
...
You may access information that you have voluntarily provided through your account on the Services, and to review, correct, or delete it by sending a request to contact@bsquared.network. You can request to change contact choices, opt-out of our sharing with others, and update your personal information and preferences.
...
Email: contact@bsquared.network,
...
We only use your personal information as permitted by law. We are required to inform you of the legal bases of our processing of your personal information, which are described in the table below. If you have questions about the legal bases under which we process your personal information, contact us at contact[@bsquared.network](mailto:privacy@consensys.net).
...
| <p>To communicate with you</p><p>To optimize our platform</p><p>For compliance, fraud prevention, and safety</p><p>To provide our service</p> | These processing activities constitute our legitimate interests. We make sure we consider and balance any potential impacts on you (both positive and negative) and your rights before we process your personal information for our legitimate interests. We do not use your personal information for activities where our interests are overridden by any adverse impact on you (unless we have your consent or are otherwise required or permitted to by law). |
...
| With your consent                                            | Where our use of your personal information is based upon your consent, you have the right to withdraw it anytime in the manner indicated in the Service or by contacting us at contact@bsquared.network. |
...
You can submit these requests by email to contact@bsquared.network. We may request specific information from you to help us confirm your identity and process your request. Applicable law may require or permit us to decline your request. If we decline your request, we will tell you why, subject to legal restrictions. If you would like to submit a complaint about our use of your personal information or response to your requests regarding your personal information, you may contact us at contact@bsquared.network or submit a complaint to the data protection regulator in your jurisdiction. You can find your data protection regulator [here](http://ec.europa.eu/justice/article-29/structure/data-protection-authorities/index_en.htm).
  `
  return (
    <Layout >
      <Box sx={{
      ...
      >
        <ReactMarkdown remarkPlugins={[remarkGfm]} skipHtml>{md}</ReactMarkdown>
      </Box>
    </Layout>
  )
}
