...
import ConnectDialog from "components/Modals/ConnectModal";
import { ReactNode, useEffect, useMemo, useState } from "react";
import { parseBtcAmount, shorterAddress } from "utils";
import { formatUnits, parseEther } from "viem";
import { useAccount, useBalance, useConnect, usePrepareSendTransaction, useSendTransaction, useWalletClient } from "wagmi";
          ...
          <Box sx={{
            ...
            <>
              <Grid mt={'100px'} container width={'100%'} mb='20px' >
                <Grid item xs={6}>Wallet Address:  {shorterAddress((isBtc ? btc.address : address) || '')}</Grid>
                <Grid item xs={6}>Balance: {isBtc ? btcBalance : evmBalance}  </Grid>
              </Grid>
...
Transfer.getLayout = (page: ReactNode) => <Layout showFooter={false}>{page}</Layout>;
